...
camiseta, short, gorra, pulsometro = Reward.create([
  ...
  {name: 'Pulsometro', kms_cost: 1000, available_units: 1, description: 'Pulsometro Running', valid_from: "2017-04-01 00:00:00", valid_through: "2017-05-01 00:00:00", image_file_name: "3.JPG", image_content_type: "image/jpeg", image_file_size: 1372943, image_updated_at: "2017-04-01 17:20:25", company_id: 1, branch_id: 1}
])
